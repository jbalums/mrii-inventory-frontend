...
const InternalReceivingFormModal = (props, ref) => {
	...
	return (
		<Modal open={open} hide={hide} size="2xl">
			<ModalHeader
				title={`Internal Receiving Form`}
				subtitle={`Receive order from internal source`}
				hide={hide}
			/>
...
export default forwardRef(InternalReceivingFormModal);
