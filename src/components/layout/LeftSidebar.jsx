...
const LeftSidebar = () => {
	...
	const isActive = (name, mustNotInclude = null) => {
	...
	return (
		<div
			className={`shadow-xl transition-all max-h-screen duration-300 bg-background flex flex-col relative md:w-64 z-10 
		${
			collapseSidebar
		...
		>
			...
			<div className="max-h-[calc(100vh-95px)] overflow-auto">
				<MagicScrollBar
					autoHeightMax={
						typeof window === "object" ? window.innerHeight - 95 : 0
					}
					autoHeightMin={
						typeof window === "object" ? window.innerHeight - 95 : 0
					}
