const Button = (props) => {
	...
	const defaultBtnClass = `text-center duration-50 hover:scale-[1.01] hover:shadow-md hover:shadow-gray-300 transition-transform rounded-lg sm:w-auto cursor-pointer`;
